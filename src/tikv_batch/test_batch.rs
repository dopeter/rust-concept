use crate::tikv_batch::test_runner::{Runner, Builder, HandleMetrics, Message, Handler};
use crate::tikv_batch::batch::{create_system, PollHandler};
...
#[test]
fn test_batch() {
    let (ctrl_tx, ctrl_fsm) = Runner::new(10);
